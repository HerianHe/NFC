...
const struct attm_desc diss_att_db[DIS_IDX_NB] =
{
    ...
    [DIS_IDX_MANUFACTURER_NAME_CHAR]        =   {ATT_DECL_CHARACTERISTIC, PERM(RD, ENABLE) | PERM(WR, ENABLE), sizeof(diss_manufacturer_name_char),
...
const struct att_char_desc diss_manufacturer_name_char = ATT_CHAR(ATT_CHAR_PROP_RD | ATT_CHAR_PROP_WR_NO_RESP, DIS_MANUFACTURER_NAME_CHAR,
                                                                                      ATT_CHAR_MANUF_NAME);
